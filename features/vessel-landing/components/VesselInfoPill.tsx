...
export function VesselInfoPill() {
  return (
    <div className="flex items-center gap-2.5 sm:gap-3 lg:gap-5 rounded-lg lg:rounded-2xl 
      bg-white/10 backdrop-blur-lg border border-white/20 
      px-3 sm:px-4 lg:px-5 py-2.5 sm:py-3 lg:py-4 shadow-lg 
      w-full sm:max-w-[420px] lg:w-[420px]"
    >
      <p className="text-[12px] sm:text-[14px] lg:text-[18px] leading-[1.3] text-white flex-1">
