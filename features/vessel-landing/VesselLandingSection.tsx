...
export function VesselLandingSection() {
  return (
    <section className="w-full">
      <div className="relative h-[680px] sm:h-[580px] md:h-[600px] lg:h-[820px] overflow-hidden rounded-xl sm:rounded-2xl lg:rounded-3xl">
        {/* Background Image */}
        <Image
          src={HeaderMainShip}
          alt="Vessel"
        ...
        {/* Content Container */}
        <div className="relative z-10 h-full px-4 sm:px-6 md:px-8 lg:px-25 pt-20 sm:pt-32 lg:py-10 flex flex-col justify-between lg:block">
          
          {/* MAIN HEADING */}
          <div className="lg:mt-30 max-w-[1400px]">
            <h1 className="lg:mt-10 text-[24px] sm:text-[38px] md:text-[48px] lg:text-[75px] leading-[1.1] sm:leading-[1.18] font-extrabold text-white max-w-[820px] drop-shadow-lg">
              MOST RELIABLE WAY <br className="hidden sm:block" />
              TO MANAGE Y<span className="stroke-text">OUR</span> <br className="hidden sm:block" />
              VESSELS
            </h1>
          </div>
